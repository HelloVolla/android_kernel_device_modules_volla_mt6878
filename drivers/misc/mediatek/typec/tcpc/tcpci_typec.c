...
//driver add by lipengpeng 20200315 start
#if IS_ENABLED(CONFIG_PRI_TYPEC_POSITIVE_NEGATIVE)
int otgdetection=-1;
...
#if IS_ENABLED(CONFIG_PRI_TYPEC_CHG_DET)
...
#endif
//driver add by lipengpeng 20200315 end
...
//driver add by lipengpeng 20200315 end
	...
	//driver add by lipengpeng 20200324 start
	#if IS_ENABLED(CONFIG_PRI_TYPEC_CHG_DET) //IS_ENABLED(CONFIG_PRI_TYPEC_CHG_DET)
...
#endif
//driver add by lipengpeng 20200324 end
	/* Report function */
