...
#include "ov08d10widemipiraw_Sensor.h"

#define PFX "OV08D10WIDE"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV08D10WIDE_SENSOR_ID,		/*record sensor id defined in Kd_imgsensor.h*/
...
static kal_uint16 ov08d10wide_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
kal_uint16 addr_data_pair_init_ov08d10wide[] = {
	0x0103, 0x01,
	0x0302, 0x3c,
	0x0303, 0x01,
	0x031e, 0x0c,
...
static void sensor_init(void)
{
	LOG_INF("v2 E\n");
#if 1	/* MULTI_WRITE */
	ov08d10wide_table_write_cmos_sensor(addr_data_pair_init_ov08d10wide,
			   sizeof(addr_data_pair_init_ov08d10wide) / sizeof(kal_uint16));
#endif
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_ov08d10wide[] = {
	0x3501, 0x4c,
	0x3502, 0xe0,
	0x366e, 0x08,
	0x3714, 0x27,
...
#endif
	ov08d10wide_table_write_cmos_sensor(addr_data_pair_preview_ov08d10wide,
				   sizeof(addr_data_pair_preview_ov08d10wide) / sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_30fps_ov08d10wide[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
kal_uint16 addr_data_pair_capture_15fps_ov08d10wide[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
#endif
	if (currefps == 150) {
		ov08d10wide_table_write_cmos_sensor(addr_data_pair_capture_15fps_ov08d10wide,
					       sizeof(addr_data_pair_capture_15fps_ov08d10wide) /
					       sizeof(kal_uint16));
	} else {
		ov08d10wide_table_write_cmos_sensor(addr_data_pair_capture_30fps_ov08d10wide,
					       sizeof(addr_data_pair_capture_30fps_ov08d10wide) /
					       sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_vga_setting_120fps_ov08d10wide[] = {
	0x3501, 0x25,
	0x3502, 0xc0,
	0x366e, 0x08,
	0x3714, 0x29,
...
static void vga_setting_120fps(void)
{
	...
	ov08d10wide_table_write_cmos_sensor(addr_data_pair_vga_setting_120fps_ov08d10wide,
				   sizeof(addr_data_pair_vga_setting_120fps_ov08d10wide) /
				   sizeof(kal_uint16));
		...
		do {
			*sensor_id = ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
			if (*sensor_id == imgsensor_info.sensor_id) {
				printk("ov08d10wide i2c write id: 0x%x, sensor id: 0x%x, ver = 0x%x<0xB1=r2a,0xB0=r1a>\n",
					imgsensor.i2c_write_id, *sensor_id, read_cmos_sensor(0x302A));
				return ERROR_NONE;
			}
			printk("ov08d10wide Read sensor id fail,write_id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
		retry = 2;
...
UINT32 OV08D10WIDE_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV08D10WIDE_MIPI_RAW_SensorInit	*/
