 ...
 ****************************************************************************/
#define PFX "HI847TELE_camera_sensor"
...
#include "hi847telemipiraw_Sensor.h"


//extern bool read_eeprom_hi847tele( kal_uint16 addr, BYTE *data, kal_uint32 size);
...
#if USE_BURST_MODE
static kal_uint16 hi847tele_table_write_cmos_sensor(
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI847TELE_SENSOR_ID,

	.checksum_value = 0xe32ded8,
	.pre = { //3264X2448@30FPS_NO PD		
		.pclk = 72000000,  //drv add by lipengpeng 20231016 
		.linelength = 828,
		.framelength = 2898, 
		.startx = 0,	
		.starty = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
	...
	{ 3296, 2480,   8,  12, 3280, 2456,  1640, 1228,    4, 2, 1632, 1224, 0, 0, 1632, 1224},  //drv add by lipengpeng custom1
};
...
static kal_uint16 hi847tele_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
static kal_uint16 hi847tele_init_setting[] = {
0x0790, 0x0100,	
0x2000, 0x0000,
0x2002, 0x0058,
0x2006, 0x40B2,
...
static void sensor_init(void)
{
	...
	hi847tele_table_write_cmos_sensor(hi847tele_init_setting, sizeof(hi847tele_init_setting)/sizeof(kal_uint16));
...
static kal_uint16 hi847tele_preview_setting[] = {
//0x0B00, 0x0000,	
0x0204, 0x0000,	
0x0206, 0x0341,	
0x020A, 0x0B3D,	
...
static void preview_setting(void)
{
	...
	hi847tele_table_write_cmos_sensor(hi847tele_preview_setting, sizeof(hi847tele_preview_setting)/sizeof(kal_uint16));
...
//3264X2448@30FPS_NO PD
static kal_uint16 hi847tele_capture_setting[] = {
//0x0B00, 0x0000,	
0x0204, 0x0000,	
0x0206, 0x0341,	
0x020A, 0x0B3D,	
...
static void capture_setting(kal_uint16 currefps)
{
	...
	hi847tele_table_write_cmos_sensor(hi847tele_capture_setting,
		sizeof(hi847tele_capture_setting)/sizeof(kal_uint16));
...
static kal_uint16 hi847tele_normal_video_setting[] = {
//0x0B00, 0x0000,	
0x0204, 0x0000,	
0x0206, 0x0341,	
0x020A, 0x0B3D,	
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	hi847tele_table_write_cmos_sensor(hi847tele_normal_video_setting,
		sizeof(hi847tele_normal_video_setting)/sizeof(kal_uint16));
...
//720p@90fps
static kal_uint16 hi847tele_hs_video_setting[] = {
//0x0B00, 0x0000,	
0x0204, 0x0000,	
0x0206, 0x033E,	
0x020A, 0x03BF,	
...
static void hs_video_setting(void)
{
	...
	hi847tele_table_write_cmos_sensor(hi847tele_hs_video_setting,
		sizeof(hi847tele_hs_video_setting)/sizeof(kal_uint16));
...
//1080p@60fps
static kal_uint16 hi847tele_slim_video_setting[] = {
//0x0B00, 0x0000,	
0x0204, 0x0000,	
0x0206, 0x033F,	
0x020A, 0x05A0,	
...
static void slim_video_setting(void)
{
	...
	hi847tele_table_write_cmos_sensor(hi847tele_slim_video_setting,
		sizeof(hi847tele_slim_video_setting)/sizeof(kal_uint16));

	pr_debug("[%s] Hi-847 slim_video setting end\n", __func__);
}
//drv add by lipengpeng 20231013 start
static kal_uint16 hi847tele_custom1_setting[] = {
//0x0B00, 0x0000,	
0x0204, 0x0200,	
0x0206, 0x0341,	
0x020A, 0x0B3C,	
...
static void custom1_setting(void)
{
  ...
  hi847tele_table_write_cmos_sensor(hi847tele_custom1_setting,
		sizeof(hi847tele_custom1_setting) / sizeof(kal_uint16));
}	/*	custom1_setting  */
...
UINT32 HI847TELE_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* HI847TELE_MIPI_RAW_SensorInit */
