...
#include "s5k3p9spsubmipiraw_Sensor.h"
...
#define PFX "S5K3P9SPSUB_camera_sensor"
#define LOG_INF(format, args...) pr_debug(PFX "[%s] " format, __func__, ##args)

#define S5K3P9SPSUB_EEPROM_READ_ID  0xA0
#define S5K3P9SPSUB_EEPROM_WRITE_ID 0xA1

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
		.sensor_id = S5K3P9SPSUB_SENSOR_ID,
...
static kal_uint16 read_cmos_eeprom_8(kal_uint16 addr)
{
	...
	iReadRegI2C(pusendcmd, 2, (u8 *)&get_byte, 1, S5K3P9SPSUB_EEPROM_READ_ID);
	return get_byte;
}
...
UINT32 S5K3P9SPSUB_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	return ERROR_NONE;
}	/*	S5K3P9SPSUB_MIPI_RAW_SensorInit	*/
