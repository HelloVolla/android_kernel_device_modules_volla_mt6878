...
int sc8815a_set_boost_current(struct sc8815a *sc, int curr)
{
	...
	sc8815a_update_bits(sc, SC8815A_REG_05, 0xff, 0xff);
				 ...
				 const struct i2c_device_id *id)
{
	...
	sc->i2c_wake_lock = wakeup_source_register(sc->dev, "sc8815a_i2c_wake_lock");
...
static void sc8815a_charger_remove(struct i2c_client *client)
{
