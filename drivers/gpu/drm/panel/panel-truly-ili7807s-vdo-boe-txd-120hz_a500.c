...
static struct drm_display_mode default_mode = {
	.clock = 266439,		//htotal*vtotal*vrefresh/1000   1138*2492*60/1000 361670
	.hdisplay = HAC,
	.hsync_start = HAC + HFP,
	.hsync_end = HAC + HFP + HSA,
	.htotal = HAC + HFP + HSA + HBP,
	.vdisplay = VAC,
	.vsync_start = VAC + 1380,
	.vsync_end = VAC + 1380 + VSA,
	.vtotal = VAC + 1380 + VSA + VBP, //2882
};
...
/* pri LAX10-192 added by xuejian 20240409 begin*/
    ...
    strcpy(current_lcm_info.vendor,"TXD-BOE-09");
