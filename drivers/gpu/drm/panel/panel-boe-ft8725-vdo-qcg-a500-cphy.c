...
#include "../../../misc/mediatek/pri/pri_common_node/pri_common_node.h"
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "boe,ft8725,vdo-qcg-a500-cphy", },
	{}
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-boe-ft8725-vdo-qcg-a500-cphy",
		.owner = THIS_MODULE,
