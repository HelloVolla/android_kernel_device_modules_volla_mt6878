...
static char bl_tb[] = { 0x51, 0x0A, 0xAB };
static char hbm_tb[] = { 0x51, 0x17, 0xFF }; // drv modify hbm function
struct lcm {
    struct device* dev;
...
unsigned int vtdr6130a_cmd_fhd_buf_thresh[14] = {
	896, 1792, 2688, 3584, 4480,
	5376, 6272, 6720, 7168, 7616,
	7744, 7872, 8000, 8064
};
unsigned int vtdr6130a_cmd_fhd_range_min_qp[15] = {0, 0, 1, 1, 3, 3, 3, 3, 3, 3,5, 5, 5, 9, 12};
unsigned int vtdr6130a_cmd_fhd_range_max_qp[15] = {4, 4, 5, 6, 7, 7, 7, 8,9, 10, 10, 11, 11, 12, 13};
int vtdr6130a_cmd_fhd_range_bpg_ofs[15] = {2, 0, 0, -2, -4, -6, -8, -8, -8, -10,-10, -12, -12, -12, -12};
...
static void lcm_panel_init(struct lcm* ctx)
{
	...
	lcm_dcs_write_seq_static(ctx,0xD0,0x84,0x05,0xF0,0x14,0xA5,0x00,0x35,0x4E,0x13,0x4F,0x00,0x00,0x4E,0x33,0x50,0x00,0x00,0x00,0x05,0x55,0x13,0x13,0x13,0x00,0x00,0x00);//for CW8792
	...
	lcm_dcs_write_seq_static(ctx,0x6c,0x00);//00:120HZ  01:90HZ
	...
	/*lcm_dcs_write_seq_static(ctx,0x70,0x11,0x00,0x00,0xab,0x30,0x80,0x0a,0x6e,0x04,0xb0,0x00,0x1e,0x02,0x58,0x02,0x58,0x02,0x00,0x01,0x19,0x00,
	0x20,0x05,0xd0,0x00,0x08,0x00,0x01,0x00,0x47,0x03,0x0d,0x18,0x00,0x10,0xf0,0x07,0x10,0x20,0x00,0x06,0x0f,0x0f,0x33,
	0x0e,0x1c,0x2a,0x38,0x46,0x54,0x62,0x69,0x70,0x77,0x79,0x7b,0x7d,0x7e,0x02,0x02,0x22,0x00,0x2a,0x40,0x2a,0xbe,0x3a,
	0xfc,0x3a,0xfa,0x3a,0xf8,0x3b,0x38,0x3b,0x78,0x3b,0xb6,0x4b,0xb6,0x4b,0xf4,0x4b,0xf4,0x6c,0x34,0x84,0x74,0x00,0x00,
	0x00,0x00,0x00,0x00);*/
	/*lcm_dcs_write_seq_static(ctx,0x70,0x11,0x00,0x00,0x8B,0x30,0x80,0x0A,0x6E,0x04,0xB0,0x00,0x1E,0x02,0x58,0x02,//15
							0x58,0x02,0x00,0x01,0x19,0x00,0x20,0x05,0xD0,0x00,0x08,0x00,0x01,0x00,0x47,0x03,0x0D,//17
							0x18,0x00,0x10,0xF0,0x07,0x10,0x20,0x00,0x06,0x0F,0x0F,0x33,0x0E,0x1C,0x2A,0x38,0x46,
							0x54,0x62,0x69,0x70,0x77);
	lcm_dcs_write_seq_static(ctx,0x65,0x36);
	lcm_dcs_write_seq_static(ctx,0x70,0x79,0x7B,0x7D,0x7E,0x02,0x02,0x22,0x00,0x2A,0x40,0x2A,0xBE,0x3A,0xFC,0x3A,
							0xFA,0x3A,0xF8,0x3B,0x38,0x3B,0x78,0x3B,0xB6,0x4B,0xB6,0x4B,0xF4,0x4B,0xF4,0x6C,0x34,
							0x84,0x74,0x00,0x00,0x00,0x00,0x00,0x00);*/
	lcm_dcs_write_seq_static(ctx,0x70,0x12,0x00,0x00,0x89,0x30,0x80,0x0A,0x6E,0x04,0xB0,0x00,0x1E,0x02,0x58,0x02,0x58,0x02,0x00,0x02,0x45);
	lcm_dcs_write_seq_static(ctx,0x65,0x14);
	lcm_dcs_write_seq_static(ctx,0x70,0x00,0x20,0x02,0xEA,0x00,0x08,0x00,0x0D,0x03,0x97,0x03,0x0D,0x18,0x00,0x10,0xF0,0x03,0x0C,0x20,0x00);
	lcm_dcs_write_seq_static(ctx,0x65,0x28);
	lcm_dcs_write_seq_static(ctx,0x70,0x06,0x0B,0x0B,0x33,0x0E,0x1C,0x2A,0x38,0x46,0x54,0x62,0x69,0x70,0x77,0x79,0x7B,0x7D,0x7E,0x01,0x02);
	lcm_dcs_write_seq_static(ctx,0x65,0x3c);
	lcm_dcs_write_seq_static(ctx,0x70,0x01,0x00,0x09,0x40,0x09,0xBE,0x19,0xFC,0x19,0xFA,0x19,0xF8,0x1A,0x38,0x1A,0x78,0x1A,0xB6,0x2A,0xB6);
	lcm_dcs_write_seq_static(ctx,0x65,0x50);
	lcm_dcs_write_seq_static(ctx,0x70,0x2A,0xF4,0x2A,0xF4,0x4B,0x34,0x63,0x74,0x00,0x00,0x00,0x00,0x00,0x00);
...
static struct mtk_panel_params ext_params_120hz = {
    ...
    .dsc_params = {
		...
		.ext_pps_cfg = {
			.enable = 1,
			.rc_buf_thresh = vtdr6130a_cmd_fhd_buf_thresh,
			.range_min_qp = vtdr6130a_cmd_fhd_range_min_qp,
			.range_max_qp = vtdr6130a_cmd_fhd_range_max_qp,
			.range_bpg_ofs = vtdr6130a_cmd_fhd_range_bpg_ofs,
		},
/*        .rc_buf_thresh[0] = 14,
        .rc_buf_thresh[1] = 28,
        .rc_buf_thresh[2] = 42,
    ...
    unsigned int level)
{
    ...
    if (rawlevel > 2730 && rawlevel <= 4095)
        rawlevel = 2731;
    ...
    pr_err("%s hxl_ch_bl level=%d, rawlevel=%d, bl_tb[1]=0x%x, bl_tb[2]=0x%x\n",
...
// drv-Fixed the issue of entering aod and TP having touch-pengzhipeng-20230516-start
bool drv_get_vtdr6130a_doze_state(void)
{
    if (IS_ERR_OR_NULL(g_ctx)) {
        return false;
    }
	printk("[%d]hxl_ch_doze g_ctx->doze_en:%d !!\n", __LINE__, g_ctx->doze_en);
    return g_ctx->doze_en;
}
EXPORT_SYMBOL_GPL(drv_get_vtdr6130a_doze_state);
// drv-Fixed the issue of entering aod and TP having touch-pengzhipeng-20230516-end
...
bool panel_visionox_vtdr6130a_fod_is_enabled(void)
{
...
EXPORT_SYMBOL(panel_visionox_vtdr6130a_fod_is_enabled);
/* drv modify K80NF-263, K80NF-273 end */
/* drv modify ts suspend enter for fod reporting start */
void panel_visionox_vtdr6130a_fod_set_callback(void* func)
{
	if (!IS_ERR_OR_NULL(g_ctx)) {
	    pr_err("%s", __func__);
		if(IS_ERR_OR_NULL(ts_suspend_callback)) {
...
EXPORT_SYMBOL(panel_visionox_vtdr6130a_fod_set_callback);
/* drv modify ts suspend enter for fod reporting end */
...
static int lcm_probe(struct mipi_dsi_device* dsi)
{
    ...
    pr_info("%s- lcm,vtdr6130a,cmd,60hz\n", __func__);
    /* drv modify hbm function start */
    ctx->hbm_en = false;
    ctx->hbm_stat = false;
    /* drv modify hbm function end */
#if IS_ENABLED(CONFIG_PRIZE_HARDWARE_INFO)
    strcpy(current_lcm_info.chip, "VTDR6130A");
    strcpy(current_lcm_info.vendor, "HST");
    sprintf(current_lcm_info.id, "0x%02x", 0x01);
    strcpy(current_lcm_info.more, "1200*2670");
#endif
    return ret;
}
...
static struct mipi_dsi_driver lcm_driver = {
    ...
    .remove = lcm_remove,
    .driver = {
        .name = "panel-vtdr6130a-fhdp-amoled-dsi-cmd-dphy",
        .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("vtdr6130a AMOLED CMD LCD Panel Driver");
