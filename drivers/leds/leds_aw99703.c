...
#define AW99703_DRIVER_VERSION "v1.7.0"
...
EXPORT_SYMBOL(chargepump_set_backlight_level);
...
{
	//struct aw99703_data *drvdata = dev_get_drvdata(dev);
	printk("aw99703_resume start ...");
	//drv by huangyu Disable the ic aw99703 wake up process,Probabilistic bright backlight
	//aw99703_backlight_init(drvdata);
	return 0;
}
