...
static int __init ftm_node_init(void)
{
	...
	printk("drv ftm_node ftm_node_init\n");
...
{
	printk("drv ftm_node ftm_node_exit \n");
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("drv ftm_node driver");
MODULE_AUTHOR("Liao Jie<liaojie@drvgroup.com>");