...
static int brl_power_on(struct goodix_ts_core *cd, bool on)
{
	...
	if (on) {
        pri_aw95016a_gpio_set(aw95016_ext_gpio_P0_1, 1, 0); //RST
        usleep_range(4000, 4100);
        pri_aw95016a_gpio_set(aw95016_ext_gpio_P0_6, 1, 1);//TSP_VDDI
		usleep_range(10000, 10100);
        pri_aw95016a_gpio_set(aw95016_ext_gpio_P0_7, 1, 1);//TSP_AVDD
		usleep_range(15000, 15100);
		pri_aw95016a_gpio_set(aw95016_ext_gpio_P0_1, 1, 1);//RST
		usleep_range(4000, 4100);
...
power_off:
	pri_aw95016a_gpio_set(aw95016_ext_gpio_P0_1, 1, 0); //RST
    usleep_range(15000, 15100);
    pri_aw95016a_gpio_set(aw95016_ext_gpio_P0_7, 1, 0); //TSP_AVDD
	return ret;
}
...
static int brl_reset(struct goodix_ts_core *cd, int delay)
{
    ...
    pri_aw95016a_gpio_set(aw95016_ext_gpio_P0_1, 1, 0);
	usleep_range(2000, 2100);
	pri_aw95016a_gpio_set(aw95016_ext_gpio_P0_1, 1, 1);
	if (delay < 20)
