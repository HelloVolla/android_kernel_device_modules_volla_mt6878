...
static unsigned char CTPM_FW_DEF[] = {
	#include "ILI7807S_GQ5005_LH_V0x00.0x03_AP_5_MP_1_20240103.ili"
};

static unsigned char CTPM_FW_WCL[] = {
	#include "ILI77600A_GQ5005_LH_V0x00.0x00_AP_2_MP_1_20230817.ili"
};
