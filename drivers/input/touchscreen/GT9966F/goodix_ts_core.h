...
#ifndef _GT9966F_CORE_H_
#define _GT9966F_CORE_H_
...
//#define CONFIG_TOUCHSCREEN_GOODIX_BRL_I2C

#define GOODIX_CORE_DRIVER_NAME "goodix_ts_gt9966f"
#define GOODIX_PEN_DRIVER_NAME "goodix_ts_gt9966f,pen"
#define GOODIX_DRIVER_VERSION "v1.4.3"
...
#define TS_DEFAULT_FIRMWARE "GT9966_1D.44.01.18_9A96A963.bin"
#define TS_DEFAULT_CFG_BIN "goodix_gt9966f_cfg_group_v06_20251017.bin"
...
enum GOODIX_GESTURE_TYP {
	...
	GESTURE_M = (1 << 4),
	GESTURE_W = (1 << 5),
	GESTURE_SINGLE_TAP = (1 << 7),
	GESTURE_BA = (1 << 8),
	GESTURE_AB = (1 << 9),
	GESTURE_AA = (1 << 10),
	GESTURE_BB = (1 << 11),
	GESTURE_DOUBLE_TAP = (1 << 12),
...
//drv-mod by shenwenbin for double tap function 20250903 start
    ...
    int (*suspend_gesture_power_on)(struct goodix_ts_core *cd, bool on);
#endif
