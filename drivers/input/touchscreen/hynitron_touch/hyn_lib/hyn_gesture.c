...
//drv added by chenjiaxi, gesture, begin
#if IS_ENABLED(CONFIG_PRI_COMMON_NODE)
#ifdef HYN_GESTURE_EN
...
#endif
#endif
//drv added by chenjiaxi, gesture, end
...
int hyn_gesture_init(struct hyn_ts_data *ts_data)
{
    ...
    ts_data->gesture_is_enable = DISABLE;
...
#if IS_ENABLED(CONFIG_PRI_COMMON_NODE)
#ifdef HYN_GESTURE_EN
	pri_common_node_register("GESTURE_SUB", &drv_gesture_func);
#endif
#endif
