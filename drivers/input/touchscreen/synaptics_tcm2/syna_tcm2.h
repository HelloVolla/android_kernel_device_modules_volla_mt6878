...
/*pri LAX10-1016 modify by ocean 20240619 end*/
	...
	int aft_enabled; //anti fake touch sensor
	int palm_sensor_status; //fake touch status
/*pri LAX10-1016 modify by ocean 20240620 start*/
	int fw_boot_status;  //Distinguish different firmware parameters
	int screenstate_type_state;
...
/*pri LAX10-1016 modify by ocean 20240620 end*/
	...
	struct notifier_block sensor_notifier;
