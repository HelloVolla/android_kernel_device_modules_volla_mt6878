...
mgk_64_k61_device_modules = [
    ...
    "drivers/gpu/drm/panel/panel-visionox-hc5622-dphy-cmd-120hz.ko",
    ...
    "drivers/misc/mediatek/pri/prize_oled_node/oled_driver.ko",
    "drivers/input/touchscreen/focaltech_ft3681_spi/focaltech_ft3681_spi.ko",
    ...
    "drivers/leds/aw_haptic_hv/aw_haptic.ko",
    ...
    #add by huangxinglve, 20250527, add for als calibration begin
    "drivers/misc/mediatek/pri/pri_common_node/pri_common_node.ko",
    #add by huangxinglve, 20250527, add for als calibration end
    ...
    #add by huangxinglve, 20250527, add for als calibration begin
    "drivers/misc/mediatek/pixel_manager/pixel_manager.ko",
    #add by huangxinglve, 20250527, add for als calibration end
    ...
    "drivers/misc/mediatek/typec/tcpc/tcpc_rt1718s.ko",
    ...
    "drivers/power/supply/mt5706_wireless_charger.ko",
    ...
    "drivers/power/supply/upm6722.ko",
    "drivers/power/supply/sh366100_battery.ko",
    ...
    # prize add by chenwenhui for camera pmic start
    "drivers/regulator/wl28681-regulator.ko",
    # prize add by chenwenhui for camera pmic end
